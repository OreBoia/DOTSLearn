...
public partial struct ShootingSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        // foreach (var (tank, transform, color) in SystemAPI.Query<RefRO<Tank>,
        ...
        //     state.EntityManager.SetComponentData<URPMaterialPropertyBaseColor>(cannonBallEntity, color.ValueRO);
        //
        ...
        //     state.EntityManager.SetComponentData<LocalTransform>(cannonBallEntity, ballTransform);
        //
